...
export const CalendarLegend: React.FC = () => {
  return (
    <div className="flex flex-wrap items-center justify-start gap-x-3 gap-y-2 sm:gap-6 py-2.5 px-3 sm:px-4 rounded-xl bg-white border border-slate-200/80 text-[11px] sm:text-xs text-slate-700 shadow-sm">
      <span className="font-bold text-slate-500 uppercase tracking-wider text-[10px] sm:text-[11px] mr-0.5">
        Status Legend:
      </span>

      {/* Available */}
      <div className="flex items-center gap-1.5">
        <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-emerald-500 shadow-sm shrink-0" />
      ...
      {/* Partially Booked */}
      <div className="flex items-center gap-1.5">
        <span className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-amber-400 shadow-sm shrink-0" />
