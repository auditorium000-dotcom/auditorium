    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-150">
      ...
      >
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 id="cancel-modal-title" className="text-lg font-bold text-slate-900 tracking-tight">
              Cancel this booking?
            </h3>
        ...
        {/* Warning Description */}
        <div className="p-4 rounded-xl bg-rose-50 border border-rose-200 text-xs text-rose-800 leading-relaxed font-medium">
